...
public class ShiftingLeftResiduePos  extends ResiduePos  implements Comparable{
	public int [] location;
	public int trailingblanks = 0;
	public ShiftingLeftResiduePos(int x, int y,int trailingblanks)
	{
		super(x,y);
		location = new int [2];
		location[0]=x;
	...
	public ShiftingLeftResiduePos(ResiduePos rp, int trailingblanks)
	{
...
//			return false;
	...
	public int compareTo(Object o) {
		ShiftingLeftResiduePos r = (ShiftingLeftResiduePos) o;
